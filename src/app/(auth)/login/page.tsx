  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-emerald-900/20 via-slate-900 to-slate-900" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mt-6 bg-slate-800/30 border border-slate-700/30 rounded-xl p-4">
          <p className="text-xs text-slate-500 text-center mb-2">Demo Account (Create your own or use)</p>
